...
export class Macos1723539418403 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."carts_card_state_enum" AS ENUM('ACTIVE', 'COMPLETED', 'FAILED', 'PENDING')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_card_state_enum" AS ENUM('ACTIVE', 'COMPLETED', 'FAILED', 'PENDING')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "discounts" ADD "discount_value" bigint NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "discounts" ALTER COLUMN "discount_shop_id" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "discounts" ALTER COLUMN "discount_applies_to_ids" SET DEFAULT array[]::uuid[]`,
    );
    await queryRunner.query(
      `ALTER TABLE "carts" ADD CONSTRAINT "FK_b3f0538ccd4517d57cf123d7689" FOREIGN KEY ("card_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_110e6928fc122d86a702220bec6" FOREIGN KEY ("card_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "orders" DROP CONSTRAINT "FK_110e6928fc122d86a702220bec6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "carts" DROP CONSTRAINT "FK_b3f0538ccd4517d57cf123d7689"`,
    );
    await queryRunner.query(
      `ALTER TABLE "discounts" ALTER COLUMN "discount_applies_to_ids" SET DEFAULT ARRAY[]`,
    );
    await queryRunner.query(
      `ALTER TABLE "discounts" ALTER COLUMN "discount_shop_id" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "discounts" DROP COLUMN "discount_value"`,
    );
